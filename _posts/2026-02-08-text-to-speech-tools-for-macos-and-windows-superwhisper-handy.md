...
image:
  ...
  alt: "Superwhisper and Handy text-to-speech applications for macOS and Windows"
---
...
**[Handy](https://handy.computer/)** is an open-source, free tool that brings voice input to Windows. What makes it exceptional is its flexibility—you can use local speech-to-text models, giving you privacy and offline functionality without relying on cloud services.
...
**[Superwhisper](https://superwhisper.com/)** is my go-to tool on macOS. While it offers cloud-based transcription, the truly valuable feature is its support for local speech-to-text models—good enough for most use cases without the latency or privacy concerns of cloud processing.
